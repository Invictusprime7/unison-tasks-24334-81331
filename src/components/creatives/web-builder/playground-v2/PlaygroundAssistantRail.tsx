...
export function PlaygroundAssistantRail({ pageTitle, items }: PlaygroundAssistantRailProps) {
      ...
      <ScrollArea className="flex-1">
        <div className="space-y-2 p-3">
          {blockers.length === 0 ? (
            ...
            blockers.map((b, i) => (
              <div key={b.id} className="rounded-md border bg-card p-2.5 text-xs">
        ...
        <Button
          ...
          onClick={() =>
            toast({
              ...
              description: "AI auto-fix will be available in the next milestone.",
            })
          }
        >
