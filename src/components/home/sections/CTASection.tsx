...
export function CTASection({ onStartLauncher }: CTASectionProps) {
  return (
    <section className="py-12 sm:py-16 md:py-20 bg-[#0a0a12]">
      <div className="container mx-auto px-4">
        <Card className="max-w-4xl mx-auto bg-gradient-to-r from-cyan-500/20 via-fuchsia-500/20 to-lime-500/20 border border-cyan-500/30 shadow-[0_0_40px_rgba(0,255,255,0.2)]">
          <CardContent className="py-8 sm:py-10 md:py-12 px-4 sm:px-6 text-center">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-3 sm:mb-4 text-white">Ready to <span className="text-cyan-400 drop-shadow-[0_0_20px_rgba(0,255,255,0.5)]">launch?</span></h2>
            ...
            <Button 
              ...
              className={cn(
                "text-base sm:text-lg px-6 sm:px-8 h-12 sm:h-14 bg-cyan-500 text-black font-bold w-full sm:w-auto",
