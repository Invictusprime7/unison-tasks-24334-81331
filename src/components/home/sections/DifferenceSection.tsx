...
export function DifferenceSection() {
  return (
    <section className="bg-[#0d0d18] py-12 sm:py-16 md:py-20">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-8">
            <Card className="border-red-500/30 bg-red-500/5">
              <div className="p-4 sm:p-6">
                <h3 className="text-base sm:text-lg text-red-400 font-semibold mb-3 sm:mb-4">❌ Static Templates</h3>
            ...
            <Card className="border-lime-500/50 bg-lime-500/5 shadow-[0_0_20px_rgba(132,204,22,0.1)]">
              <div className="p-4 sm:p-6">
                <h3 className="text-base sm:text-lg text-lime-400 font-semibold mb-3 sm:mb-4">✓ Unison Systems</h3>
                <div className="space-y-2.5 sm:space-y-3 text-xs sm:text-sm text-gray-400">
