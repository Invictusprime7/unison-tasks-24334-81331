...
const salonRecipes: Record<string, PageRecipe> = {
  ...
  "contact.view": {
    ...
    sections: [
      ...
      { type: "contact-split", order: 10, defaultProps: { showMap: true, showHours: true, showPhone: true }, intents: ["contact.submit", "button.click"] },
      COMMON_SECTIONS.faq(),
      COMMON_SECTIONS.footer(),
    ],
    requiredTables: [],
...
const ecommerceNavItems: NavItem[] = [
  {
    ...
    boundIntents: ["cart.add", "pay.checkout"],
    order: 0,
    visibility: "nav",
  },
  {
...
const ecommerceRecipes: Record<string, PageRecipe> = {
  home: {
    ...
    sections: [
      COMMON_SECTIONS.hero("pay.checkout"),
      { type: "featured-products", order: 10, defaultProps: { limit: 8, showBadges: true }, intents: ["cart.add"] },
    ...
    requiredIntents: ["cart.add", "newsletter.subscribe"],
  },
  ...
  "shop.browse": {
    ...
    sections: [
      ...
      { type: "product-grid", order: 10, defaultProps: { columns: 4, showQuickView: true }, intents: ["cart.add"] },
      { type: "pagination", order: 20, defaultProps: {}, intents: [] },
      COMMON_SECTIONS.footer(),
    ],
    requiredTables: ["products", "categories"],
    requiredIntents: ["cart.add"],
  },
  ...
  "cart.view": {
    ...
    sections: [
      { type: "cart-full", order: 0, defaultProps: { showThumbnails: true, showQuantity: true }, intents: ["cart.checkout"] },
      { type: "upsells", order: 10, defaultProps: { limit: 4 }, intents: ["cart.add"] },
      COMMON_SECTIONS.footer(),
    ],
    requiredTables: ["cart_items"],
    requiredIntents: ["cart.checkout"],
  },
  ...
  "about.view": {
    ...
    sections: [
      ...
      COMMON_SECTIONS.testimonials(),
      COMMON_SECTIONS.ctaBanner("pay.checkout"),
      COMMON_SECTIONS.footer(),
    ],
    requiredTables: [],
    requiredIntents: [],
...
const localServiceNavItems: NavItem[] = [
  {
    ...
    boundIntents: ["lead.capture", "button.click"],
    order: 0,
    visibility: "nav",
  },
  {
  ...
  },
  {
    ...
    boundIntents: ["contact.submit", "button.click"],
    order: 4,
    visibility: "both",
  },
];
...
const localServiceRecipes: Record<string, PageRecipe> = {
  ...
  "contact.view": {
    ...
    sections: [
      ...
      { type: "contact-info", order: 20, defaultProps: { showMap: true, showHours: true }, intents: ["button.click"] },
      COMMON_SECTIONS.footer(),
    ],
    requiredTables: [],
    requiredIntents: ["lead.capture", "contact.submit"],
