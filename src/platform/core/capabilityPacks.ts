  ...
  database: {
    tables: [
      ...
      },
      {
        ...
        requiredColumns: ['id', 'workflow_id', 'status'],
      ...
      },
      {
        ...
        purpose: 'Individual scheduled steps of a workflow run.',
        requiredColumns: ['id', 'workflow_run_id', 'step_index', 'action_type', 'action_config', 'status', 'scheduled_at'],
        ownershipColumn: null,
        publicRead: false,
        publicInsert: false,
        policies: [],
