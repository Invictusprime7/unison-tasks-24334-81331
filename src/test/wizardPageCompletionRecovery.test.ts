...
describe('isolated Wizard page completion recovery', () => {
  ...
  it('uses a required industry conversion action for roles without a placement', () => {
  ...
  it('identifies malformed candidates that must not be reused as model context', () => {
