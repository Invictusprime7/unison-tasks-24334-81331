...
/**
 * Single source of truth for fallback CSS — generated by the wizard's
 * deterministic token injection system (THEME_PRESETS → ThemeTokens → CSS).
 * No more hand-rolled HSL strings scattered across the codebase.
 */
