...
- IMMERSIVE / 3D EXPERIENCE LAYER: WebGL is available ONLY through the snapshot-owned experience facades "@/unison/experience" (barrel), "@/unison/experience/canvas", "@/unison/experience/tokens", "@/unison/experience/scene", "@/unison/experience/media", "@/unison/experience/stage". They export ExperienceCanvas, LightRig, ImmersiveHero, ParticleField, SceneBackground, FloatingMedia, DepthGallery, ProductStage, ModelViewer, useExperienceMaterial, useExperienceEnabled. Never import "three", "@react-three/fiber", "@react-three/drei" or create a raw WebGL <canvas> yourself; never author files under "/src/unison/experience/".
